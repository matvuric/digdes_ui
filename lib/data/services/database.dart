...
class DB {
  ...
  static final _factories = <Type, Function(Map<String, dynamic> map)>{
    ...
    PostAttachment: (map) => PostAttachment.fromMap(map),
  };
  ...
  Future<Iterable<T>> getAll<T extends DbModel>(
      {Map<String, Object?>? whereMap, int? take, int? skip}) async {
