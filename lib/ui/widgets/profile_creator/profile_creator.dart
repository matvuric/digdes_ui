...
import 'package:digdes_ui/ui/widgets/profile_creator/profile_creator_vm.dart';
...
class ProfileCreator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var viewModel = context.watch<ProfileCreatorViewModel>();
  ...
  static Widget create() {
    return ChangeNotifierProvider(
        create: (BuildContext context) =>
            ProfileCreatorViewModel(context: context),
        child: const ProfileCreator());
  }
}
